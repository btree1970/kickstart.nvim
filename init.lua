...
vim.keymap.set('n', '<leader>td', ':split | term', { desc = 'Open terminal in horizontal split', noremap = true, silent = true })
vim.keymap.set('n', '<leader>tv', ':vsplit | term', { desc = 'Open terminal in vertical split', noremap = true, silent = true })
...
vim.keymap.set('n', '<C-a>', 'ggVG', { desc = 'Select all text in the buffer' })
-- [[ Basic Autocommands ]]
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- ts_ls = {},
        --
        -- Add Ruby support with Solargraph
        solargraph = {
          -- You can add custom settings for Solargraph here if needed
          settings = {
            solargraph = {
  ...
  },
  {
    ...
    config = function()
      ...
      -- Debug logging
      print 'Alpha-nvim config function started'
    ...
    ╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝
      ...
      print 'Alpha-nvim config function completed'
    end,
  },
  {
